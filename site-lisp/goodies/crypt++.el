...
(defun crypt-find-file-hook ()
  ...
  (let ((buffer-file-name buffer-file-name)
	...
	(binary-process-input t) ; dsr, Win32
	(binary-process-output nil) ; dsr, Win32
...
(defun crypt-write-file-hook ()
  ...
  (let ((binary-process-input nil) ; dsr, Win32
	(binary-process-output t)) ; dsr, Win32
